package com.example.appphotograph
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        pick_button.setOnClickListener {
            ...
            // Se a versão do dispositivo for maior ou igual a versão "Marshmalow": pedir autorização
            ...
            else { // Caso contrário: não pedir autorização
                pickImageFromGalery()
            }
        }
